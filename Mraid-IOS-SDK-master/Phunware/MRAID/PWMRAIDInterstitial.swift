...
public class PWMRAIDInterstitial : UIViewController, MRAIDDelegate {
    public var interstitial:PWInterstitial!
    ...
    public func initialize(placement:Placement, parentViewController:UIViewController, interstitial:PWInterstitial){
